...
Result compare (const PokerHand &player, const PokerHand &opponent) {
  ...
  std::cout<< "A" <<std::endl;
  while(1){
  if (_is_SF(player.handmap, kickerA)) { std::cout<<"SF_found" <<std::endl; kickerA[0]=8;break;}
  ...
  if (_is_flush(player.handmap, kickerA)) {std::cout<<"flush_found!" << std::endl; kickerA[0]=5;break;}
  if (_is_straight(player.handmap, kickerA)) {std::cout<<"straight_found!" << std::endl; kickerA[0]=4;break;}
  ...
  std::cout<<"B" <<std::endl;
  while(1){
  if (_is_SF(opponent.handmap, kickerB)) { std::cout<<"SF_found" <<std::endl; kickerB[0]=8;break;}
  ...
  if (_is_flush(opponent.handmap, kickerB)) {std::cout<<"flush_found!" << std::endl; kickerB[0]=5;break;}
  if (_is_straight(opponent.handmap, kickerB)) {std::cout<<"straight_found!" << std::endl; kickerB[0]=4;break;}
